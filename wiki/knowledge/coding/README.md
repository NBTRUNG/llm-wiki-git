...
- [agent-coding-workflow.md](agent-coding-workflow.md) — required coding-session bootstrap. Coding agents read the full Coding Pack once at session/assignment start.
