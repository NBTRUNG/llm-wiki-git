...
Every request starts here: [[harness/read-workflow.md]]. Do not skip — it owns the canonical read path, source-of-truth decision, and knowledge lookup metric.
...
- Archive (non-canonical imports): [[archive/]]
